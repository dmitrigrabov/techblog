...
export type ListCreditNoteLineItemEndpointProductListCreditNoteLineItemResponseModel = {
  id: string;
  creditNoteId: string;
...
export const listCreditNoteLineItemEndpointProductListCreditNoteLineItemResponseModel = z.object({
  id: z.string(),
