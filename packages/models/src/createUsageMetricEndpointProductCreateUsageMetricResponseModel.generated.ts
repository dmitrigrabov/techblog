...
export type CreateUsageMetricEndpointProductCreateUsageMetricResponseModel = {
  id: string;
...
export const createUsageMetricEndpointProductCreateUsageMetricResponseModel = z.object({
  id: z.string(),
