...
export type DeleteUsageMetricEndpointProductDeleteUsageMetricResponseModel = {
  id: string;
  ...
  propertyFilters: Record<string, Record<string, never>>;
  caseSensitive?: (boolean | null) | undefined;
  propertiesToNegate?: (Array<string> | null) | undefined;
  parameters: Array<CustomMetricParameter>;
};

export const deleteUsageMetricEndpointProductDeleteUsageMetricResponseModel = z.object({
  id: z.string(),
  ...
  propertyFilters: z.record(z.string(), z.object({})),
