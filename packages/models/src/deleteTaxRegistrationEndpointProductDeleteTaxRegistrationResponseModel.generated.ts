...
export type DeleteTaxRegistrationEndpointProductDeleteTaxRegistrationResponseModel = {
  id: string;
...
export const deleteTaxRegistrationEndpointProductDeleteTaxRegistrationResponseModel = z.object({
  id: z.string(),
