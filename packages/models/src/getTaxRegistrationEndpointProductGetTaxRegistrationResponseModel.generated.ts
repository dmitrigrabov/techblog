...
export type GetTaxRegistrationEndpointProductGetTaxRegistrationResponseModel = {
  id: string;
...
export const getTaxRegistrationEndpointProductGetTaxRegistrationResponseModel = z.object({
  id: z.string(),
