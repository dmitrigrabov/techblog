...
export type UpdateUsageMetricEndpointProductUpdateUsageMetricResponseModel = {
  id: string;
...
export const updateUsageMetricEndpointProductUpdateUsageMetricResponseModel = z.object({
  id: z.string(),
