...
export type Stable20240101ProductCreateCreditNoteLineItemResponseModel = {
  id: string;
  creditNoteId: string;
...
export const stable20240101ProductCreateCreditNoteLineItemResponseModel = z.object({
  id: z.string(),
