...
export type Stable20240101CreateCreditNoteLineItemRequestModel = {
  creditNoteId: string;
  ...
  invoiceLineItemIds?: Array<string> | undefined;
};

export const stable20240101CreateCreditNoteLineItemRequestModel = z.object({
  ...
  invoiceLineItemIds: z.array(z.string()).optional(),
});
