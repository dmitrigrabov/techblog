...
import type { ProductListTaxRegistrationPaginatedResponseModel } from "packages/models/src/productListTaxRegistrationPaginatedResponseModel.generated.ts";
import {
  createTaxRegistrationRequestModel,
  type CreateTaxRegistrationRequestModel,
} from "packages/models/src/createTaxRegistrationRequestModel.generated.ts";
import type { ProductCreateTaxRegistrationResponseModel } from "packages/models/src/productCreateTaxRegistrationResponseModel.generated.ts";
...
app.post("/tax-registrations", validate("json", createTaxRegistrationRequestModel), async (c) => {
  const db = createDb(c.env.DB);
  const body = c.req.valid("json");
...
) => Promise<ProductListTaxRegistrationPaginatedResponseModel>;
...
) => Promise<ProductCreateTaxRegistrationResponseModel>;
