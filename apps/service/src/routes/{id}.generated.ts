...
import type { ArchiveTaxRateEndpointProductArchiveTaxRateResponseModel } from "packages/models/src/archiveTaxRateEndpointProductArchiveTaxRateResponseModel.generated.ts";
import type { GetTaxRegistrationEndpointProductGetTaxRegistrationResponseModel } from "packages/models/src/getTaxRegistrationEndpointProductGetTaxRegistrationResponseModel.generated.ts";
import {
...
} from "packages/models/src/updateTaxRegistrationEndpointUpdateTaxRegistrationRequestModel.generated.ts";
import type { UpdateTaxRegistrationEndpointProductUpdateTaxRegistrationResponseModel } from "packages/models/src/updateTaxRegistrationEndpointProductUpdateTaxRegistrationResponseModel.generated.ts";
import type { DeleteTaxRegistrationEndpointProductDeleteTaxRegistrationResponseModel } from "packages/models/src/deleteTaxRegistrationEndpointProductDeleteTaxRegistrationResponseModel.generated.ts";
...
app.put(
  ...
  validate("param", z.object({ id: z.string() })),
  validate("json", updateTaxRegistrationEndpointUpdateTaxRegistrationRequestModel),
  async (c) => {
    const db = createDb(c.env.DB);
    const params = c.req.valid("param");
    const body = c.req.valid("json");
...
) => Promise<ArchiveTaxRateEndpointProductArchiveTaxRateResponseModel>;
...
) => Promise<GetTaxRegistrationEndpointProductGetTaxRegistrationResponseModel>;
...
) => Promise<UpdateTaxRegistrationEndpointProductUpdateTaxRegistrationResponseModel>;
...
) => Promise<DeleteTaxRegistrationEndpointProductDeleteTaxRegistrationResponseModel>;
