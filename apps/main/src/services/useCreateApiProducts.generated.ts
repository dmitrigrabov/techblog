...
export type UseCreateApiProductsArgs = {
  Authorization: string;
  "sequence-version"?: "2024-07-30" | undefined;
  body: Stable20240730ProductRequest;
};

export const useCreateApiProducts = (
  options: UseMutationOptions<
    Stable20240730ProductResponse,
    Error,
    UseCreateApiProductsArgs,
    unknown
  > = {},
) => {
  ...
  return useMutation({
    mutationFn: (args: UseCreateApiProductsArgs) =>
      apiFetch("/products", stable20240730ProductResponse, {
        method: "POST",
